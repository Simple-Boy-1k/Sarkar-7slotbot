# =========================================================
# TELEGRAM CUSTOM PREMIUM EMOJI IDs (Replace with your IDs)
# =========================================================

PREMIUM_EMOJI_IDS = {
    "FIRE": "5386654653012122522",         # 🔥
    "SWORDS": "5386654653012122523",       # ⚔️
    "LOCK": "5386654653012122524",         # 🚫
    "TELEGRAM": "5386654653012122525",     # 📬
    "KEY": "5386654653012122526",          # 🔑
    "PURPLE_STAR": "5386654653012122527",  # 💜 Purple Star Icon for Channels
    "GREEN_CHECK": "5386654653012122528"   # 🟢 Green Check Icon for Verify
}
...
# --- READY-TO-USE ICONS FOR TEXT & BUTTONS ---
...
# Button Styling Icons (Purple Star & Green Check)
BTN_PURPLE_STAR = "💜"  # Purple Star for Channel Buttons
BTN_GREEN_CHECK = "🟢"  # Green Check for Verify Button
